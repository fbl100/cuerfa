...
__device__ eraLEAPSECOND *changes;
__device__ int NDAT = -1;


__device__ int eraGetLeapSeconds(eraLEAPSECOND **leapseconds)
/*
...
__device__ void eraSetLeapSeconds(eraLEAPSECOND *leapseconds, int count)
/*
...
__device__ int eraDatini(const eraLEAPSECOND *builtin, int n_builtin,
